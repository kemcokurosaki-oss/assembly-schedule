...
function _getDrawingColumns() {
    return [
        ...
        { name: "text",            label: "タスク",     width: 120, tree: true, align: "center", editor: { type: "text", map_to: "text" } },
...
function _getTripColumns() {
    return [
        ...
        { name: "machine",         label: "機械",     width: 40,  align: "center", editor: { type: "text", map_to: "machine" } },
        { name: "unit",            label: "ユニ",     width: 40,  align: "center", editor: { type: "text", map_to: "unit" } },
        { name: "text",            label: "タスク",   width: 230, tree: true, align: "center", editor: { type: "text", map_to: "text" } },
...
function addNewProjectFilter() {
    ...
    const escaped = (window.CSS && typeof window.CSS.escape === 'function') ? window.CSS.escape(val) : val.replace(/["\\]/g, '\\$&');
    let existing = list.querySelector(`.project-chk-item[value="${escaped}"]`);
    if (!existing) {
        const label = document.createElement('label');
